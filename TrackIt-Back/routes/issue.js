...
let setRouter = (app) => {
    ...
    app.get(baseUrl+'/view/:issueId',issueController.getIssueDetails)
          /**
	 * @api {get} /api/v1/users/view/:issueId To get deatils of a single issue
	 * @apiVersion 0.0.1
	 * @apiGroup Issue
	 *
    ...
    app.post(baseUrl+'/edit/:issueId',issueController.editIssue)
     /**
	 * @api {post} /api/v1/users/edit/:issueId To get deatils of a single issue
	 * @apiVersion 0.0.1
	 * @apiGroup Issue
	 *
     * @apiParam {String} issueId The issueId of the issue
    ...
    app.post(baseUrl + '/dashboard/lodge', issueController.lodgeissue)
          /**
	 * @api {post} /api/v1/users/dashboard/lodge To get deatils of a single issue
	 * @apiVersion 0.0.1
	 * @apiGroup Issue
	 *
